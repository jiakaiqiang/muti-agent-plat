...
import { claimRouteRecovery, clearRouteRecovery, isRouteModuleLoadError } from '@/router/routeLoadRecovery'

const routes: RouteRecordRaw[] = [
  {
    path: '/desktop', name: 'desktop',
    component: () => import('../views/DesktopConnectionView.vue'),
    meta: { section: 'desktop', title: '连接与更新' }
  },
  {
    path: '/',
    redirect: '/workspace'
...
router.beforeEach((to) => {
  if (to.path === '/workflows') return '/workspace'
})
