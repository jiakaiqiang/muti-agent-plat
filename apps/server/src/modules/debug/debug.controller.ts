  ...
  runtimeInvocations(@Param('sessionId') sessionId: string) {
    return ok({
      items: this.runtime.listInvocations(sessionId).map((invocation) => ({
        ...
        workspaceIndexGeneration: invocation.workspaceIndexGeneration,
        workspaceIndexStatus: invocation.workspaceIndexStatus,
        workspaceIndexComplete: invocation.workspaceIndexComplete,
        workspaceRevisionAtStart: invocation.workspaceRevisionAtStart,
        supplementalContextAttempt: invocation.supplementalContextAttempt,
        supplementalContextDurationMs: invocation.supplementalContextDurationMs,
        evidenceBytes: invocation.evidenceBytes,
        evidencePaths: invocation.evidencePaths,
